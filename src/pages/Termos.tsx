...
const Termos = () => {
  return (
    <div className="min-h-screen flex flex-col">
      <Seo
        title="Termos de Uso — Melhores TVs"
        description="Termos e condições de uso do site Melhores TVs: regras, limitações de responsabilidade e direitos dos usuários."
        path="/termos"
      />
      <Header />
