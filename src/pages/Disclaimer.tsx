...
const Disclaimer = () => {
  return (
    <div className="min-h-screen flex flex-col">
      <Seo
        title="Disclaimer — Melhores TVs"
        description="Aviso de isenção de responsabilidade do Melhores TVs sobre análises, opiniões e uso de links de afiliado do Mercado Livre."
        path="/disclaimer"
      />
      <Header />
